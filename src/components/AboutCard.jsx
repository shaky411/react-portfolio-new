...
return (
  ...
  <div className="flex-col p-5 m-3 w-1/1 lg:w-1/2 xl:w-1/3 2xl:w-1/3 space-y-10 bg-white border rounded-2xl shadow-xl hover:shadow-pink-500/30 md:flex-col md:space-y-0 md:space-x-10 md:m-3 md:p-16">
