...
export default function ProjectCard(props) {
  return (
    <div className="flex flex-col p-4 m-3 w-1/1 md:w-1/2 lg:w-1/2 xl:w-1/4 space-y-10 bg-white border rounded-2xl shadow-2xl hover:shadow-xl hover:shadow-indigo-500/30 md:flex-row md:space-y-0 md:space-x-10 md:m-0 md:p-16">
